...
assert(is_file($root . '/public/assets/css/personal-platform.css'), 'Personal platform stylesheet must exist.');
...
assert(is_file($root . '/public/assets/js/personal-platform.js'), 'Personal platform script must exist.');
...
assert(is_file($root . '/views/hire.php'), 'Business view must exist.');
...
assert(is_string($router) && str_contains($router, "'engineering'=>"), 'Router must expose engineering view.');
assert(is_string($router) && str_contains($router, "'case-studies'=>"), 'Router must expose case studies.');
assert(is_string($router) && str_contains($router, "'cv'=>"), 'Router must expose recruiter CV.');
assert(is_string($router) && str_contains($router, "'hire'=>"), 'Router must expose business view.');
...
assert(is_string($header) && str_contains($header, '/assets/css/personal-platform.css'), 'Personal platform CSS must be loaded by the shared header.');
assert(is_string($header) && str_contains($header, '/assets/js/personal-platform.js'), 'Personal platform JS must be loaded by the shared header.');
